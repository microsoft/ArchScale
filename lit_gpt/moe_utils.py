...
def _permute(num_tokens_per_expert, total_tokens, ep_degree, num_local_experts):
    global TOKEN_GROUP_ALIGN_SIZE_M
    x_padded_per_expert = total_tokens + num_local_experts * TOKEN_GROUP_ALIGN_SIZE_M
